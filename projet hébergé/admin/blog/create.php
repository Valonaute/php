...
if (!empty($_POST) AND !empty($_FILES)){
    ...
    if(count($errors) <1){
        // insert 
        $pdo->prepare("INSERT INTO blog (id_article, titre, description, image ) VALUES (null, ?, ?, ?)")->execute([$_POST['titre'], $_POST['description'], $titre_du_fichier]);
        // Upload image 
...
<div id="content" >
    <form action="<?= $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data" class="form" style="padding-left: 200px;">
        <fieldset>
            <legend> Création de l'article </legend>
            <br>
